...
/* big-endian parsing */
DSK_INLINE uint16_t dsk_uint16be_parse (const uint8_t *rep);
DSK_INLINE int16_t  dsk_int16be_parse  (const uint8_t *rep);
DSK_INLINE uint32_t dsk_uint24be_parse (const uint8_t *rep);
DSK_INLINE int32_t  dsk_int24be_parse  (const uint8_t *rep);
DSK_INLINE uint32_t dsk_uint32be_parse (const uint8_t *rep);
...
DSK_INLINE int16_t  dsk_int16le_parse  (const uint8_t *rep);
DSK_INLINE uint32_t dsk_uint24le_parse (const uint8_t *rep);
DSK_INLINE int32_t  dsk_int24le_parse  (const uint8_t *rep);
DSK_INLINE uint32_t dsk_uint32le_parse (const uint8_t *rep);
...
DSK_INLINE void     dsk_uint16be_pack  (uint16_t       value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_int16be_pack   (int16_t        value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_uint24be_pack  (uint32_t       value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_int24be_pack   (int32_t        value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_uint32be_pack  (uint32_t       value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_int32be_pack   (int32_t        value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_uint64be_pack  (uint64_t       value,
                                        uint8_t       *rep);
...
DSK_INLINE void     dsk_uint16le_pack  (uint16_t       value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_int16le_pack   (int16_t        value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_uint32le_pack  (uint32_t       value,
                                        uint8_t       *rep);
DSK_INLINE void     dsk_int32le_pack   (int32_t        value,
                                        uint8_t       *rep);
...
DSK_INLINE uint16_t
dsk_uint16be_parse (const uint8_t *rep)
{
  return (((uint16_t)rep[0]) << 8)
       | (((uint16_t)rep[1]) << 0);
}
DSK_INLINE int16_t
dsk_int16be_parse  (const uint8_t *rep)
{
  return (int16_t) dsk_uint16be_parse (rep);
}
DSK_INLINE uint32_t
dsk_uint24be_parse (const uint8_t *rep)
{
...
DSK_INLINE int32_t
dsk_int24be_parse (const uint8_t *rep)
{
...
DSK_INLINE int32_t
dsk_int32be_parse  (const uint8_t *rep)
{
  return (int32_t) dsk_uint32be_parse (rep);
}
DSK_INLINE uint32_t
dsk_uint32be_parse (const uint8_t *rep)
{
...
DSK_INLINE uint64_t
dsk_uint64be_parse (const uint8_t *rep)
{
...
DSK_INLINE int64_t
dsk_int64be_parse  (const uint8_t *rep)
{
...
DSK_INLINE int32_t
dsk_int24le_parse (const uint8_t *rep)
{
...
/* --- packing --- */
DSK_INLINE void
dsk_uint16be_pack  (uint16_t       value,
                    uint8_t       *rep)
{
  rep[0] = value>>8;
  rep[1] = value>>0;
...
DSK_INLINE void
dsk_int16be_pack   (int16_t        value,
                    uint8_t       *rep)
{
  dsk_uint16be_pack (value, rep);
}
DSK_INLINE void
dsk_uint24be_pack  (uint32_t       value,
                    uint8_t       *rep)
{
  rep[0] = value>>16;
  rep[1] = value>>8;
...
DSK_INLINE void
dsk_int24be_pack   (int32_t        value,
                    uint8_t       *rep)
{
  dsk_uint24be_pack (value, rep);
}
DSK_INLINE void
dsk_uint32be_pack  (uint32_t       value,
                    uint8_t       *rep)
{
  rep[0] = value>>24;
  rep[1] = value>>16;
...
DSK_INLINE void
dsk_int32be_pack   (int32_t        value,
                    uint8_t       *rep)
{
  dsk_uint32be_pack (value, rep);
}
DSK_INLINE void
dsk_uint64be_pack  (uint64_t       value,
                    uint8_t       *rep)
{
#if DSK_SIZEOF_SIZE_T == 4
...
DSK_INLINE void
dsk_int64be_pack   (int64_t        value,
                    uint8_t       *rep)
{
...
DSK_INLINE void
dsk_int24le_pack   (int32_t        value,
                    uint8_t       *rep)
{
