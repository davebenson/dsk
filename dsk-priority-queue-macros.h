...
#define DSK_PRIORITY_QUEUE_REMOVE_MIN(pq) \
        DSK_PRIORITY_QUEUE_REMOVE_(type,count,array,compare, 0)
#define DSK_PRIORITY_QUEUE_ADD(pq, value) \
        DSK_PRIORITY_QUEUE_ADD(type,count,array,compare, value)
  ...
  do{                                                                          \
    ...
    for (;;)                                                                   \
      {                                                                        \
        ...
        _DSK_PRIORITY_QUEUE_TMP_SWAP(_dsk_fixup, _dsk_min_idx);                \
        _dsk_fixup = _dsk_min_idx;                                             \
      }                                                                        \
  }while(0)
#define DSK_PRIORITY_QUEUE_ADD(type,count,array,compare, value)                \
  do{                                                                          \
        ...
        if (_dsk_rv <= 0)                                                      \
          {                                                                    \
            ...
            break;                                                             \
                                                                               ...
                                                                               \
        _DSK_PRIORITY_QUEUE_TMP_SWAP(_dsk_fixup_at, _dsk_parent);              \
        _dsk_fixup_at = _dsk_parent;                                           \
      }                                                                        \
  }while(0)

// internal: for use by macros that define _dsk_tmp_swap
#define _DSK_PRIORITY_QUEUE_TMP_SWAP(a, b)                                     \
  do{                                                                          \
