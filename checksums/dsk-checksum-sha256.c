...
static inline void
sha256_process_64 (SHA256_CTX *ctx,
...
static void
sha256_feed (SHA256_CTX *ctx, size_t length, const uint8_t *data)
{
  uint32_t left, fill;
...
static void
dsk_checksum_sha256_init (void *instance)
{
  SHA256_CTX *ctx = instance;
  sha256_init (ctx);
}

static void
dsk_checksum_sha256_feed (void *instance,
                          size_t len,
                          const uint8_t *data)
{
  SHA256_CTX *ctx = instance;
  sha256_feed (ctx, len, data);
}

static void
dsk_checksum_sha256_end (void *instance,
                         uint8_t *hash_out)
{
  SHA256_CTX *ctx = instance;
  sha256_done (ctx, hash_out, 256/32);
}
static void
dsk_checksum_sha224_end (void *instance,
                         uint8_t *hash_out)
{
  SHA256_CTX *ctx = instance;
