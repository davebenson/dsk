                                              ...
                                              DskError    **error)
{
  ...
  bool do_lock = (flags & DSK_DIR_NEW_SKIP_LOCKING) == 0;
  if (do_lock)
    {
...
void
dsk_dir_set_erase_on_destroy (DskDir *dir, bool do_erase)
{
...
dsk_dir_set_contents (DskDir                 *dir,
                      ...
                      DskError              **error)
{
  bool use_tmp = (flags & DSK_DIR_SET_CONTENTS_NO_TMP_FILE) == 0;
